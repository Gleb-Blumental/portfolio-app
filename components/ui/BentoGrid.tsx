  ...
  return (
    ...
    >
      <div className={'${id === 6} && "flex justify-center h-full"'}>
        ...
        <div className={
          cn(
            titleClassName, 'group-hover/bento:translate-x-2 transition duration-200 relative md:h-40 flex flex-col px-5 p-5 lg:p-10'
          )}>
        ...
        {id === 2 && (
          <div className="flex-gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
            <div className="flex flex-col gap-3 lg:gap-8">
              {['React.js', 'Next.js', 'Java', 'Docker', 'Javascript', 'AWS', 'Kubernetes', 'MySQL'].map((item) => (
